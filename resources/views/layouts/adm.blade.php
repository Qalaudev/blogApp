        ...
        <li class="nav-item active">
            ...
            <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item active" href="{{ route('adm.management.users')}}">User List</a>
                    <a class="collapse-item active" href="{{ route('adm.management.category')}}">Category List</a>
                    <a class="collapse-item active" href="{{ route('adm.management.commentary')}}">Commentary List</a>
                    <a class="collapse-item active" href="{{ route('adm.management.post') }}">Post List</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="utilities-border.html">Post</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <!-- Topbar Search -->
                <form action="{{route('adm.management.search')}}" method="GET"
