...
@section('content')
    <div class="container d-flex justify-content-center align-items-center">
        <div class="row">
            <br><a style="text-align: center" class="form-control" href="{{route('home.page')}}">Home</a>
            <br><a style="text-align: center" class="form-control" href="{{route('posts.create')}}">Post Create</a>
            <br><a style="text-align: center" class="form-control" href="{{route('create.category')}}">Category Create</a>
            <br><a style="text-align: center" class="form-control" href="{{route('index.category')}}">List Category</a>
            <br><a style="text-align: center" class="form-control" href="{{route('posts.index')}}">List Post</a>
        </div>
    </div>
@endsection
    ...
    <nav class="navbar navbar-expand-lg shadow-sm fixed-top"><a class="navbar-brand" href=""><img src="../SiteAssets/images/icons8-university-50 (1).png"/><span></span></a>
        <div class="navbar-collapse">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link profile-dropdown" href="index.blade.php" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="rounded-circle" src="../SiteAssets/images/person.jpg"/><span class="d">jane doe</span></a>
                    <div class="dropdown">
